            ...
            <div class="centers">
                <div class="BItextc">
                    <h3>Student Basic Information</h3>
                        ...
                        <input type="text" placeholder="Year" maxlength="10" id="inputc" name="year" required><br>
                        <label for="Id#" id="textcc">ID Number</label>
                        <input type="text" placeholder="ID#"id="inputc" maxlength="12" name="idnumber" required> <br>
                        ...
                        <input type="text" placeholder="ex/ 0955-297-8471"id="inputc" maxlength="13" name="contactnumber" required><br>
                        <br>
                        <div class="login">
